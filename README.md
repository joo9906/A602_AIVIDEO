...
### 혹시라도 사용해보시려면 test/chmera_test.py를 실행하시면 직접 해보실 수 있습니다. 
...
## 모델 구성
### 모델
    - 모델 학습 파일 : training/model_optimizing.ipynb 
    - 하이퍼 파라미터 저장 파일 : training/config.py
    - 모델 파일 : test/model/best_model.h5
    - 인코더 파일 : test/model/label_encoder.pkl
